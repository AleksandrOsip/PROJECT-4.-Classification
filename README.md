...
### Оглавление <a name="1"></a>
1. [Описание проекта](#проекта)
2. [Какой кейс решаем?](#решаем)
3. [Краткая информация о данных](#данных)
4. [Этапы работы над проектом](#проектом)
5. [Результаты](#результаты)
6. [Выводы](#выводы)

#### Описание проекта <a name="проекта"></a>

Вам предоставили данные о последней маркетинговой кампании, которую проводил банк: задачей было привлечь клиентов для открытия депозита. Вы должны проанализировать эти данные, выявить закономерность и найти решающие факторы, повлиявшие на то, что клиент вложил деньги именно в этот банк. Если вы сможете это сделать, то поднимете доходы банка и поможете понять целевую аудиторию, которую необходимо привлекать путём рекламы и различных предложений.

![image.png](https://github.githubassets.com/images/icons/emoji/unicode/2b06.png) [к оглавлению](#1)

#### Какой кейс решаем? <a name="решаем"></a>
...
#### Этапы работы над проектом <a name="проектом"></a>
